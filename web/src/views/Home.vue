  ...
  <div class="home-container">
    ...
    <footer class="footer">
      <div class="footer-content">
        ...
        <p class="copyright">Copyright © 2025 Nav-Item | <a href="https://github.com/Amosgantian/nav-item" target="_blank" class="footer-link">Powered by sweet</a></p>
      </div>
    </footer>
...
.home-container {
  min-height: 95vh;
  /* 外部链接优先，如果失败，则尝试加载本地文件 */
  background-image: url('https://aomega-yahai.serv00.net/wp-content/uploads/2025/10/background.jpg'), url('/background.jpg');
